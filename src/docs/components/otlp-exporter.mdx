...
For additional configurations, see [AppDynamics OpenTelemetry documentation](https://docs.appdynamics.com/22.5/en/application-monitoring/appdynamics-for-opentelemetry/configure-the-opentelemetry-collector).
