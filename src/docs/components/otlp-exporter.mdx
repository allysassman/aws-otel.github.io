...
* AppDynamics SaaS Controller >= 22.4.0.
* OpenTelemetry Collector version >= 0.36.0

<SubSectionSeparator />

### Configuration (Collector)

The configuration takes place in the OTLP exporter in your Collector YAML config file.
...
For additional configurations, see [AppDynamics OpenTelemetry documentation](https://docs.appdynamics.com/latest/en/application-monitoring/appdynamics-for-opentelemetry/configure-the-opentelemetry-collector).
...
exporters:
  otlphttp:
    endpoint: "https://<your region>-sls-agent-api.saas.appdynamics.com" // See [SaaS Domains and Regions](https://docs.appdynamics.com/display/PAA/SaaS+Domains+and+IP+Ranges).
    headers: {"x-api-key": "****************"}
service:
  pipelines:
    traces:
